...
async def abertura_caixa(
    ...
    return {"status": 200, "msg": "Caixa aberto com sucesso.", "caixa": novo_caixa}
...
async def fechamento_caixa(
    ...
    if not caixa_aberto:
        raise HTTPException(
            status_code=404,
            detail="Nenhum caixa aberto encontrado para este funcionário.",
        )
    ...
    return {"status": 200, "msg": "Caixa fechado com sucesso.", "caixa": caixa_aberto}
