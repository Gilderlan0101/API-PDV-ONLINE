...
async def information_about_sales_and_products_and_employees(user_id: int) -> Dict[str, List[Dict[str, Any]]] | None:
    """
    ...
    try:
        ...
        for return_products in query_product:
            ...
            caixa_id = str(return_products.caixa.id) if return_products.caixa else "SEM_CAIXA"
            ...
            sale_data = {
                "sales": {
                    ...
                    "employee": (
                        return_products.funcionario.nome if return_products.funcionario else "Não foi possível localizar nome do funcionário."
                    ),
                },
                "products": {
