...
async def create_mock_data_and_sell_all_stock():
    ...
    async with in_transaction() as conn:
        ...
        funcionarios_empresa2 = [
            {"nome": "Roberto Caixa", "email": "roberto.caixa@empresa2.com", "cargo": "Caixa", "senha": "1234"},
            {"nome": "Carla Atendente", "email": "carla.atendente@empresa2.com", "cargo": "Atendente", "senha": "1234"},
            {"nome": "Lucas Entregador", "email": "lucas.entregador@empresa2.com", "cargo": "Entregador", "senha": "1234"},
            {"nome": "Fernanda Cozinheira", "email": "fernanda.cozinheira@empresa2.com", "cargo": "Cozinheira", "senha": "1234"},
        ]
        ...
        produtos_data_comuns = [
            ...
            {"code": "BEB002", "name": "Guaraná 2L", "cost": 4.50, "sale": 7.00, "supplier": "Antarctica", "group": "Bebidas"},
            {"code": "BEB003", "name": "Água Mineral 500ml", "cost": 1.50, "sale": 3.00, "supplier": "Crystal", "group": "Bebidas"},
        ]

        # Produtos exclusivos Empresa 1 (Pizzaria)
        produtos_exclusivos_empresa1 = [
            {"code": "PIZ001", "name": "Pizza Calabresa", "cost": 15.00, "sale": 25.00, "supplier": "Forninho", "group": "Pizzas"},
            {"code": "PIZ002", "name": "Pizza Frango Catupiry", "cost": 16.00, "sale": 26.00, "supplier": "Forninho", "group": "Pizzas"},
            {"code": "PIZ003", "name": "Pizza Portuguesa", "cost": 17.00, "sale": 27.00, "supplier": "Forninho", "group": "Pizzas"},
            {"code": "PIZ004", "name": "Pizza Margherita", "cost": 14.00, "sale": 24.00, "supplier": "Forninho", "group": "Pizzas"},
            {"code": "PIZ005", "name": "Pizza Quatro Queijos", "cost": 18.00, "sale": 28.00, "supplier": "Forninho", "group": "Pizzas"},
            {"code": "ESF001", "name": "Esfiha de Carne", "cost": 3.00, "sale": 6.00, "supplier": "Forninho", "group": "Esfihas"},
            {"code": "ESF002", "name": "Esfiha de Queijo", "cost": 2.50, "sale": 5.00, "supplier": "Forninho", "group": "Esfihas"},
        ]

        # Produtos exclusivos Empresa 2 (Restaurante)
        produtos_exclusivos_empresa2 = [
            {"code": "PRT001", "name": "Filé Mignon", "cost": 25.00, "sale": 45.00, "supplier": "Açougue", "group": "Pratos Principais"},
            {"code": "PRT002", "name": "Frango Grelhado", "cost": 12.00, "sale": 22.00, "supplier": "Açougue", "group": "Pratos Principais"},
            {"code": "PRT003", "name": "Salmão ao Molho", "cost": 20.00, "sale": 38.00, "supplier": "Peixaria", "group": "Pratos Principais"},
            {"code": "SAL001", "name": "Salada Caesar", "cost": 8.00, "sale": 15.00, "supplier": "Hortifruti", "group": "Saladas"},
            {"code": "SAL002", "name": "Salada Verde", "cost": 6.00, "sale": 12.00, "supplier": "Hortifruti", "group": "Saladas"},
            {"code": "SOB001", "name": "Pudim de Leite", "cost": 4.00, "sale": 8.00, "supplier": "Confeitaria", "group": "Sobremesas"},
            {"code": "SOB002", "name": "Mousse de Chocolate", "cost": 3.50, "sale": 7.00, "supplier": "Confeitaria", "group": "Sobremesas"},
        ]
        ...
        caixas_empresa1 = await Caixa.filter(usuario_id=admin.id).prefetch_related('funcionario').all()
        caixas_empresa2 = await Caixa.filter(usuario_id=admin_2.id).prefetch_related('funcionario').all()
